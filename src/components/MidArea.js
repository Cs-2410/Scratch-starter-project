...
function MidArea({ area_list, add_list, event_values }) {
  ...
  const handleClick = (arr, id) => {
    ...
    var cnt = setInterval(() => {
      ...
      // If Repeat component is at the previous index
  ...
  return (
    <div className="flex-1 h-full overflow-auto p-3">
      <div className="flex justify-between">
        <div className="font-bold mb-5 text-center border-2 rounded text-white bg-pink-400 p-2 w-auto">
          Mid Area
        </div>
            ...
            <div className="w-60" key={l.id}>
              <Paper elevation={3} className="p-4">
                <div className="w-52 p-2">
                  {l.comps &&
                    l.comps.length > 0 && ( // Check if l.comps is present and not empty
